const PricingCard = ({ title, price, features, isPopular }) => {
    return (
        <div className="h-full">
            <div
                className={`relative h-full flex flex-col max-w-sm rounded-lg shadow-lg p-6 ${
                    isPopular
            ...
            >
                ...
                <button
                    className={`w-full py-3 rounded-lg font-bold transition duration-300 bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:opacity-90 mt-auto`}
                >
                    Choose Plan
                </button>
            </div>
